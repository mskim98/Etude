    ...
    <Card className={`border shadow-sm ${className}`}>
      <CardHeader className="pb-3 rounded-t-lg bg-primary">
        <CardTitle className="flex items-center space-x-2 text-lg font-semibold text-primary-foreground">
          ...
          <Badge variant="outline" className="text-xs font-semibold ml-2 border-primary-foreground text-primary-foreground">
          ...
          {upcomingExams.length === 0 ? (
            ...
            upcomingExams.map((exam, index) => {
              ...
              return (
                <div
                  key={index}
                  className="p-2.5 rounded-lg border-2 border-muted-foreground/15 bg-card"
                >
                  <div className="flex items-start justify-between">
                    <div className="flex items-start space-x-3">
                      <div
                        className="w-12 h-12 rounded-lg flex items-center justify-center text-xl bg-primary text-primary-foreground"
                      >
                        {exam.icon}
                      </div>
