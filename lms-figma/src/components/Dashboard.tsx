...
import { DateSection } from './dashboard/DateSection';
import { ExamSchedule } from './dashboard/ExamSchedule';
import { Announcements } from './dashboard/Announcements';
import { SubjectProgress } from './dashboard/SubjectProgress';
import { APCourses } from './dashboard/APCourses';
import { SATMockExams } from './dashboard/SATMockExams';
import { 
  BookOpen, 
  LogOut, 
  GraduationCap,
...
import type { User as UserType, Subject, APExam } from '../App';
...
export function Dashboard({ user, subjects, apExams, onStartExam, onLogout, activeSection, onSectionChange }: DashboardProps) {
  ...
  const handleStartExam = (examId: string) => {
    // Find a SAT subject to pass to the exam
    const satSubject = subjects.find(s => s.type === 'SAT');
    if (satSubject) {
      onStartExam(satSubject);
    }
  };
          ...
          <div className="flex items-center justify-between px-6 py-4">
            ...
            <div className="flex items-center space-x-6">
              <div className="flex items-center space-x-3">
                <div className="w-10 h-10 rounded-lg flex items-center justify-center shadow-md" style={{ backgroundColor: '#0091B3' }}>
                  <BookOpen className="w-6 h-6 text-white" />
                </div>
                <span className="text-2xl font-bold" style={{ color: '#0091B3' }}>ETUDE</span>
              </div>
              <div className="h-8 w-px" style={{ backgroundColor: '#B8D4D9' }} />
              <h1 className="text-xl font-bold" style={{ color: '#0091B3' }}>Dashboard</h1>
