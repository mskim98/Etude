...
export function SATDetailedResultsPage({
  selectedTest,
  onNavigate,
}: SATDetailedResultsPageProps) {
  const [selectedSection, setSelectedSection] = React.useState<
    "reading" | "writing" | "math"
  >("reading");
  const [chartSection, setChartSection] = React.useState<
    "reading" | "writing" | "math"
  >("reading");
  const [chartDataType, setChartDataType] = React.useState<
    "correct" | "incorrect"
  >("incorrect");
  if (!selectedTest) {
    return (
  ...
  const sections = [
    {
      ...
      completed:
        selectedTest.sectionProgress?.reading?.completed ||
        false,
      outOf: 800,
      percentile: 75,
      correctAnswers: 45,
    ...
    },
    {
      ...
      completed:
        selectedTest.sectionProgress?.writing?.completed ||
        false,
      outOf: 800,
      percentile: 82,
      correctAnswers: 38,
    ...
    },
    {
      ...
      completed:
        selectedTest.sectionProgress?.math?.completed || false,
      outOf: 800,
      percentile: 89,
      correctAnswers: 54,
      totalQuestions: 58,
  ...
  const averagePercentile = Math.round(
    completedSections.reduce(
      (sum, section) => sum + section.percentile,
      0,
    ) / completedSections.length,
  );

  // Calculate overall accuracy rate
  const totalCorrectAnswers = completedSections.reduce(
    (sum, section) => sum + section.correctAnswers,
    0,
  );
  const totalQuestions = completedSections.reduce(
  ...
  const wrongQuestions = [
    {
      ...
      difficulty: "Hard",
      explanation:
        "This question required understanding of the author's implicit argument about social change.",
    },
    {
      section: "Math",
      questionNumber: 32,
      ...
      difficulty: "Medium",
      explanation:
        "The equation needed to be solved using substitution method.",
    },
    {
      section: "Reading",
      questionNumber: 8,
      ...
      difficulty: "Medium",
      explanation:
        "The word's meaning changes based on the surrounding context.",
    },
  ];
              ...
              <CardContent>
                {section.completed ? (
                  ...
                  <div className="text-center py-8">
                    ...
                    >
                      Complete this section to see detailed
                      results
                    </div>
                  </div>
                )}
            ...
            <CardContent>
                ...
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart
                    data={(() => {
                      ...
                      return chartDataBySectionAndType[
                        chartSection
                      ][chartDataType];
                    })()}
                    margin={{
                  ...
                  >
                    ...
                    <defs>
                      ...
                      >
                        <stop
                          offset="0%"
                          stopColor="var(--color-status-success)"
                          stopOpacity={0.9}
                        />
                        <stop
                          offset="100%"
                      ...
                      >
                        <stop
                          offset="0%"
                          stopColor="var(--color-status-error)"
                          stopOpacity={0.9}
                        />
                        <stop
                          offset="100%"
              ...
              >
                <div className="flex items-center justify-between text-sm">
                  ...
                  >
                    Showing {chartDataType} answers for{" "}
                    {chartSection.charAt(0).toUpperCase() +
                      chartSection.slice(1)}{" "}
                    section
                  </span>
                  <span
                    style={{
            ...
            <CardContent>
              ...
              <div className="max-h-[400px] overflow-y-auto scrollbar-custom space-y-4 pb-6">
                {(() => {
                  ...
                  const wrongQuestionsBySection = {
                    ...
                    writing: [
                      ...
                      },
                      {
                        ...
                        topic: "Punctuation",
                        explanation:
                          "Comma splice error. Two independent clauses cannot be joined with just a comma.",
                      },
                      {
                        questionNumber: 44,
                        difficulty: "Medium" as const,
                  ...
                  return wrongQuestionsBySection[
                    selectedSection
                  ].map((question, index) => (
                    <div
                      key={index}
