						...
						>
							{apSubjects
								...
								.map((subject) => (
									...
									>
										<span
											className="mr-2.5 transition-transform duration-300 data-[state=active]:scale-110"
											style={{ fontSize: "18px" }}
										>
											{subject.icon}
										</span>
										<span className="relative">{subject.name.replace("AP ", "")}</span>
									</TabsTrigger>
								))}
						</TabsList>
					</div>
